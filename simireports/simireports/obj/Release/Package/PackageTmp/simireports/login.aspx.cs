...
namespace simireports.simireports
{
    ...
    {
        // VERSAO
        public static string swver = "v1.1.35.2"; // padrao: v9.9.99 - opcional extra: .9  (na terceira casa pode-se deixar apenas o primeiro digito quando o segundo for zero)
        //
