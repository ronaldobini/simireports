<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelPedidosEfetivadosEx.aspx.cs" Inherits="simireports.simireports.RelPedidosEfetivadosEx" %>
...
<body style="background-color:#222;" onload="onload();" >
    <div id="logo" style="margin-left:20px; float:left;">
        <a  title="Voltar ao Relatorio" href=" RelPedidosEfetivados.aspx"><img style=" height:50px;" src="img/syss.png" /></a>
       
    </div>
    <center>
    <div id="titulo" style="margin-top:40px; margin-right:70px; color:white; font-size:30px;">002 - Pedidos Logix (Export Mode)  <a  title="Ajuda" href="help/ped_logix.pdf"><img style=" height:25px; margin-left:20px;" src="img/help.PNG" /></a></div>
    <br />
    <p><%=sqlview %></p>
       
        <div id="filtros" style="margin-bottom:40px;">
            <form runat="server" id="filtrosPedEfetEx" action="#" method="post">
                ...
                <br>
                <input class="btn btn-primary btn-xs" style="background-color:#0a5e03;  border-color:#0a5e03;" runat="server" type="submit" value="Filtrar" onserverclick="filtrarPedEfet_Click" />
            ...
            <table class="table table-hover table-dark" style = "max-width:95%; color:white; font-size: 12px;">
                 ...
                 <thead style="background-color: #070a0e; color:white;">
                            <tr>
                                ...
                                <th scope="col" style="width: 20%; text-align:center;">Cliente</th>
                                ...
                                <th style="width: 25%;">Desc. Item</th>
                                ...
                                <th style="width: 5%; text-align:center;">Rom</th>
                                <th style="width: 5%; text-align:center;">Lib</th>
                                <th style="width: 5%; text-align:center;">Res</th>
                                ...
                                <th style="text-align:right;width: 10%;">Prazo</th>
                            </tr>
                        </thead>
                        ...
                        string condPgto = pedEfet.CondPgto;
                                    ...
                                    %>
                                            <tr>
                                                ...
                                                <td style="text-align:center;"><%= item.QtdRom %></td>
                                                <td style="text-align:center;"><%= item.QtdLib %></td>
                                                <td style="text-align:center;"><%= item.QtdRes %></td>
